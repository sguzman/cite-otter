...
- `docs/migration/` — Migration-specific docs when a project is a port or
  rewrite.
- `docs/<project-name>/` — Project-specific docs for the current project.

## Repository Directories

- `tmp/` — Reference material and scratch data that are not committed.
- `scripts/` — Shell scripts and automation helpers.
- `tests/` — Test suites and fixtures.
- `src/` — Rust source code.
- `branding/` — Logos, mascots, and branding assets.
- `docs/` — Documentation.
